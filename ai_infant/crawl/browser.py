...
class Browser:
    ...
    def __init__(self, store: Any, user_agent: str = "AI-Infant/0.1.0"):
    ...
    def fetch(self, url: str) -> Optional[FetchResult]:
        ...
        try:
            ...
            error_data = {"type": "request_error", "message": str(e), "stack": None}
            self._log_job("fetch", {"url": url}, error_data=error_data)
            return None
        except Exception as e:
            error_data = {"type": "unexpected_error", "message": str(e), "stack": None}
            self._log_job("fetch", {"url": url}, error_data=error_data)
            return None
