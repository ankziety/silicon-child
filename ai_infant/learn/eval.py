...
class GPT4oMiniJudge:
    ...
    def __init__(
        self, name: str = "gpt4o_mini_judge", evaluation_type: str = "general"
    ):
        self.name = name
...
class ClaudeHaikuJudge:
    ...
    def __init__(
        self, name: str = "claude_haiku_judge", evaluation_type: str = "general"
    ):
        self.name = name
        self.evaluation_type = evaluation_type
...
class ClaudeSonnetJudge:
    ...
    def __init__(
        self, name: str = "claude_sonnet_judge", evaluation_type: str = "general"
    ):
        self.name = name
        self.evaluation_type = evaluation_type
...
class CommandRPlusJudge:
    ...
    def __init__(
        self, name: str = "commandr_plus_judge", evaluation_type: str = "general"
    ):
        self.name = name
        self.evaluation_type = evaluation_type
    ...
    def __call__(
        ...
        try:
            ...
            response_cohere = self.client.chat(
                model="command-r-plus", message=formatted_prompt, temperature=0.1
            )
    ...
    def evaluate(
        ...
        if errors:
            raise EvaluationError(
                f"LLM Jury evaluation failed with errors: {'; '.join(errors)}"
            )
